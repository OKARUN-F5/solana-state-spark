...
const ConnectPage = () => {
  ...
  const handleConnect = (walletName: string) => {
    ...
    // Simulate wallet connection - in production this would use actual wallet adapters
    setTimeout(() => {
      // Store connected wallet info in localStorage to persist session
